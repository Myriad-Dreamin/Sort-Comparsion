...
STDSort std_sort(std_space, TEST_SIZE, "./mergesort_test.csv");
MergeSort mer_sort(test_space, TEST_SIZE, "./mergesort_test.csv");
MergeSort mix_sort(test_space, TEST_SIZE, "./mergesort_test.csv");
MergeSort mul_sort(test_space, TEST_SIZE, "./mergesort_test.csv");

Generate gen(TEST_SIZE, random_seed);

const int testing_sorts_count = 3;
Sort *testing_sorts[testing_sorts_count] = {&mer_sort, &mix_sort, &mul_sort};
std::string sorts_desc[testing_sorts_count] = {
    "primitive merge sort",
    "mixed merge sort",
    "multiway merge sort"
};
